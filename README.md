...
So let's run a quick check from the database. before any of these you can checkout my previous account : [GitHub](https://github.com/duduBmoon21)
...
const developer = {
  ...
  focus: "Building modern web applications and solving real world problems",

  mySkills: {
    languages: ["JavaScript", "Python"],
    frameworks: ["React", "Next.js", "Django", "Laravel", "Express"],
